...
export const AboutSection: React.FC<AboutSectionProps> = ({
  ...
  return (
    <section id="about" className="py-20 lg:py-28 bg-[#f8f9fa] text-[#1d3557] relative overflow-hidden scroll-mt-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="p-5 rounded-2xl bg-[#f1faee] border border-[#a8dadc] text-[#1d3557] space-y-2 shadow-sm box-pop interactive-card">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              {[
                ...
                <div key={idx} className="p-4 rounded-xl bg-white border border-slate-200 shadow-sm space-y-1 box-pop interactive-card">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <button
                ...
                className="inline-flex items-center gap-2 px-7 py-3.5 bg-[#E63946] hover:bg-[#d90429] text-white text-xs sm:text-sm font-bold uppercase tracking-wider rounded-lg shadow-md transition-all font-heading cursor-pointer hover:shadow-lg active:scale-95"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5 bg-white hover:bg-slate-100 text-[#1d3557] text-xs sm:text-sm font-bold uppercase tracking-wider rounded-lg border border-slate-300 transition-all cursor-pointer hover:shadow-md active:scale-95"
              >
        ...
        <div className="pt-8 border-t border-slate-200 space-y-8">
            ...
            {CAREER_TIMELINE.map((item, index) => {
              ...
              return (
                <button
                  ...
                  className={`p-4 rounded-xl border text-left transition-all cursor-pointer relative box-pop interactive-card ${
                    isSelected
                      ? 'bg-[#1d3557] text-white border-[#1d3557] shadow-lg scale-102'
          ...
          <div className="p-6 md:p-8 rounded-2xl bg-[#1d3557] text-white border border-[#274773] shadow-2xl box-pop interactive-card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
          {/* Mission */}
          <div className="p-8 rounded-2xl bg-white border border-slate-200 shadow-md space-y-4 box-pop interactive-card">
