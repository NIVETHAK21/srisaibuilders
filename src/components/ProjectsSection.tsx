...
export const ProjectsSection: React.FC<ProjectsSectionProps> = ({
  ...
  return (
    <section id="projects" className="py-20 lg:py-28 bg-[#f8f9fa] text-[#1d3557] relative">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-slate-200 pb-8">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3.5 bg-[#E63946] hover:bg-[#d90429] text-white text-xs sm:text-sm font-bold uppercase tracking-wider rounded shadow-md transition-all cursor-pointer font-heading"
            >
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-2 scrollbar-none">
          ...
          {categories.map((cat) => (
            <button
              ...
              className={`px-4 py-2 rounded-lg text-xs sm:text-sm font-bold uppercase tracking-wider transition-all whitespace-nowrap cursor-pointer ${
                activeFilter === cat.id
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {filteredProjects.map((project) => (
            <div
              ...
              className="group rounded-2xl bg-white border border-slate-200 overflow-hidden shadow-md hover:border-[#E63946] transition-all duration-300 hover:-translate-y-1.5 cursor-pointer flex flex-col justify-between"
            >
              {/* Card Image Banner */}
              ...
              <div className="p-5 space-y-3 flex-1 flex flex-col justify-between">
                <div className="space-y-1.5">
                  ...
                  <h3 className="text-lg font-bold font-heading text-[#1d3557] group-hover:text-[#E63946] transition-colors">
                    {project.title}
                  </h3>
